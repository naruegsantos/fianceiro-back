-- CreateEnum
CREATE TYPE "recordCategories" AS ENUM ('REVENUE', 'EXPENSE', 'TRANSFERENCE');

-- CreateEnum
CREATE TYPE "accountCategories" AS ENUM ('REVENUE', 'EXPENSE', 'ASSET');

-- CreateEnum
CREATE TYPE "roles" AS ENUM ('ADMIN', 'OPERATOR', 'GUEST');
...
CREATE TABLE "Account" (
    ...
    "accountCategory" "accountCategories" NOT NULL,
...
CREATE TABLE "Record" (
    ...
    "recordCategory" "recordCategories" NOT NULL,
    "date" TEXT NOT NULL,
